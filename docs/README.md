...
| shared Store claim contention hardening | approved two-PR plan: PR A delivers fenced ClaimSession persistence plus exact v0.2.0 legacy-client convergence; PR B adds authority-bounded retry and PGID/PID1-safe cancellation with exact adopted-child reaping; implementation not started | [active ClaimSession plan](implementation-plan/20260812-v1.0-claim-session-and-tool-cancellation-implementation-plan.md), [superseded per-key hardening plan](implementation-plan/20260811-v1.0-shared-store-claim-contention-hardening.md) |
