...
| shared Store claim contention hardening | PR A in progress after the first real two-project C2 timeout; no release-gate pass claimed | [hardening plan](implementation-plan/20260811-v1.0-shared-store-claim-contention-hardening.md) |
