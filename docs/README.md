...
SeqEvi is currently an approved v1 architecture and an initialized project
skeleton. The documents below define the implementation contract. They do not
claim that the corresponding runtime behavior already exists.
