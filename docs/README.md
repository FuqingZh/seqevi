...
| shared Store claim contention hardening | approved two-PR plan: PR A delivers authoritative architecture, legacy-lock-compatible fresh bootstrap, fenced migration, bounded expired-session cleanup and end-to-end ClaimSession annotation; PR B adds authority-bounded operation retry, PGID-safe cancellation and measured acceptance; implementation not started | [active ClaimSession plan](implementation-plan/20260812-v1.0-claim-session-and-tool-cancellation-implementation-plan.md), [superseded per-key hardening plan](implementation-plan/20260811-v1.0-shared-store-claim-contention-hardening.md) |

## Start Here

1. [Architecture overview](architecture/20260720-v1.0-seqevi-architecture.md)
2. [Sequence and evidence contract](architecture/20260810-v1.2-sequence-evidence-contract.md)
...
6. [Storage and deployment architecture](architecture/20260810-v1.2-storage-deployment-architecture.md)
