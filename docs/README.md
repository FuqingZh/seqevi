...
| --- | --- | --- |
| release-channel modernization | PR #76 merged at `f603424a7ded3fc45ab36cf1ce00842b6f43d57c`; post-merge nightly canary run `33489740338` succeeded with a 14-day SHA-named wheel/sdist artifact at development identity `0.4.0.dev16+gf603424`. CI, nightly, tag candidate, GitHub Release, PyPI, and manual dbCAN OCI remain distinct states; no formal tag or publication occurred | [implementation plan and live evidence](implementation-plan/20260901-v1.0-release-channel-modernization-implementation-plan.md#live-delivery-evidence) |
