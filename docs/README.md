...
> lane is closed through D5 with D4/D3 accepted and expansion unselected
...
| dbCAN CAZyme | target-Store D1-D4 accepted; D4 measured representative all-missing sizing, D3 proved two all-present replays, D5 is unavailable on claim-after-OCI dispatch, and expansion was not selected | [closeout](benchmarks/20260819-v1.0-dbcan-target-store-closeout.md), [D4 acceptance](benchmarks/20260819-v1.0-dbcan-d4-target-store-sizing-acceptance.md), [D3 acceptance](benchmarks/20260819-v1.0-dbcan-d3-target-store-replay-acceptance.md), [execution plan](implementation-plan/20260819-v1.0-dbcan-target-store-execution-plan.md) |
...
| shared Store cache seeding | eggNOG and dbCAN target-Store lanes closed; global seeding remains incomplete; InterPro read-only Preflight is next | [dbCAN closeout](benchmarks/20260819-v1.0-dbcan-target-store-closeout.md), [eggNOG closeout benchmark](benchmarks/20260818-v1.0-eggnog-target-store-closeout.md), [master cache-seeding plan](implementation-plan/20260807-v1.0-shared-store-cache-seeding-implementation-plan.md) |
