...
| shared Store claim contention hardening | approved two-PR plan: PR A delivers compatibility-safe discovery, idempotent open and row/byte-bounded receipts; PR B adds complete finalize reconciliation and runway-bounded PGID/PID1 cancellation; implementation not started | [active ClaimSession plan](implementation-plan/20260812-v1.0-claim-session-and-tool-cancellation-implementation-plan.md), [superseded per-key hardening plan](implementation-plan/20260811-v1.0-shared-store-claim-contention-hardening.md) |
